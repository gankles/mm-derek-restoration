...
export const LOCATIONS = [
  ...
  // --- Additional Ingham County locations ---
  {
    name: "Leslie",
    slug: "leslie",
    state: "MI",
    ...
    population: "1,834",
    populationNum: 1834,
    keywords: ["Leslie MI", "Leslie Michigan", "Ingham County"],
    responseTime: "45 minutes",
    casesCompleted: 22,
    uniqueFact: "A small village in southern Ingham County, Leslie features charming older homes and rural properties along the historic Michigan Central Railroad corridor.",
    landmarks: ["Leslie City Park", "Downtown Leslie", "Historic Railroad Depot"],
    commonIssues: ["Older home plumbing failures", "Basement moisture in aging foundations", "Storm damage to rural properties"],
    testimonial: { name: "Leslie Homeowner", text: "Our older home had a major pipe burst. M&M was here quickly and saved our hardwood floors from permanent damage.", rating: 5 }
  },
  {
    name: "Dansville",
    slug: "dansville",
    ...
    population: "587",
    populationNum: 587,
    keywords: ["Dansville MI", "Dansville Michigan", "Ingham County"],
    responseTime: "50 minutes",
    casesCompleted: 8,
    uniqueFact: "A quiet rural village in southeastern Ingham County, Dansville is surrounded by farmland and features many century-old homes with unique restoration needs.",
    landmarks: ["Dansville Village Park", "Ingham County Fairgrounds nearby", "Rural Ingham County"],
    commonIssues: ["Farmhouse water damage", "Septic system backups", "Storm damage to outbuildings"],
    testimonial: { name: "Dansville Area Farmer", text: "When our barn roof collapsed in a storm, M&M secured the building same day and prevented further water damage to equipment.", rating: 5 }
  },
  {
    name: "Onondaga",
    slug: "onondaga",
    ...
    population: "439",
    populationNum: 439,
    keywords: ["Onondaga MI", "Onondaga Michigan", "Ingham County"],
    responseTime: "45 minutes",
    casesCompleted: 6,
    uniqueFact: "A small rural community in southwestern Ingham County, Onondaga sits at the crossroads of agricultural Michigan with many properties along seasonal waterways.",
    landmarks: ["Onondaga Township Hall", "Rural Ingham County", "Grand River watershed"],
    commonIssues: ["Rural flooding", "Agricultural property damage", "Crawl space moisture"],
    testimonial: { name: "Onondaga Township Resident", text: "Living in a rural area, we weren't sure anyone would respond quickly. M&M proved us wrong.", rating: 5 }
  },
  {
    name: "Bunker Hill",
    slug: "bunker-hill",
    ...
    population: "312",
    populationNum: 312,
    keywords: ["Bunker Hill MI", "Bunker Hill Michigan", "Ingham County"],
    responseTime: "50 minutes",
    casesCompleted: 4,
    uniqueFact: "A tiny rural community in Ingham County's southeast corner, Bunker Hill features scattered homesteads and farmland with unique restoration challenges.",
    landmarks: ["Bunker Hill Township Hall", "Rural southeastern Ingham County"],
    commonIssues: ["Well water damage", "Storm damage to older structures", "Foundation moisture"],
    testimonial: { name: "Bunker Hill Property Owner", text: "Our rural property flooded and M&M drove out quickly to handle the water extraction. Professional and thorough.", rating: 5 }
  },
  {
    name: "White Oak",
    slug: "white-oak",
    ...
    population: "425",
    populationNum: 425,
    keywords: ["White Oak MI", "White Oak Michigan", "Ingham County"],
    responseTime: "50 minutes",
    casesCompleted: 5,
    uniqueFact: "A rural township community in Ingham County, White Oak features rolling farmland and wooded properties requiring specialized rural restoration services.",
    landmarks: ["White Oak Township Hall", "Rural Ingham County"],
    commonIssues: ["Seasonal flooding", "Agricultural building restoration", "Rural property storm damage"],
    testimonial: { name: "White Oak Resident", text: "Water damage in our century-old farmhouse needed careful handling. M&M restored everything while preserving the character.", rating: 5 }
  },
  // --- Additional Eaton County locations ---
  {
    name: "Bellevue",
    slug: "bellevue",
    state: "MI",
    ...
    population: "1,270",
    populationNum: 1270,
    keywords: ["Bellevue MI", "Bellevue Michigan", "Eaton County"],
    responseTime: "55 minutes",
    casesCompleted: 15,
    uniqueFact: "A historic village in eastern Eaton County along the Battle Creek River, Bellevue features well-preserved 19th-century architecture and flood-prone riverfront properties.",
    landmarks: ["Bellevue Village Park", "Battle Creek River", "Historic Downtown Bellevue"],
    commonIssues: ["River flooding", "Historic building restoration", "Storm damage to mature trees"],
    testimonial: { name: "Bellevue Business Owner", text: "The Battle Creek River flooded our shop. M&M had commercial dryers running within hours and saved our inventory.", rating: 5 }
  },
  {
    name: "Mulliken",
    slug: "mulliken",
    ...
    population: "567",
    populationNum: 567,
    keywords: ["Mulliken MI", "Mulliken Michigan", "Eaton County"],
    responseTime: "55 minutes",
    casesCompleted: 7,
    uniqueFact: "A small rural village in Eaton County, Mulliken is a tight-knit farming community where properties often include both residential and agricultural structures.",
    landmarks: ["Mulliken Village Park", "Rural Eaton County"],
    commonIssues: ["Farmstead restoration", "Basement flooding", "Septic system issues"],
    testimonial: { name: "Mulliken Area Farmer", text: "Barn fire threatened our home. M&M contained the smoke damage and cleaned everything professionally.", rating: 5 }
  },
  {
    name: "Sunfield",
    slug: "sunfield",
    ...
    population: "597",
    populationNum: 597,
    keywords: ["Sunfield MI", "Sunfield Michigan", "Eaton County"],
    responseTime: "55 minutes",
    casesCompleted: 8,
    uniqueFact: "A peaceful farming community in western Eaton County, Sunfield features turn-of-the-century homes and agricultural properties requiring careful restoration approaches.",
    landmarks: ["Sunfield Village Park", "Historic Sunfield Church", "Rural Eaton County"],
    commonIssues: ["Older home water damage", "Storm damage to agricultural buildings", "Foundation moisture problems"],
    testimonial: { name: "Sunfield Village Resident", text: "Pipe burst during a cold snap. M&M responded fast even though we're a small town. Great service.", rating: 5 }
  },
  // --- Additional Clinton County locations ---
  {
    ...
    population: "7,865",
    populationNum: 7865,
    keywords: ["St Johns MI", "St. Johns Michigan", "Clinton County"],
    responseTime: "45 minutes",
    casesCompleted: 94,
    uniqueFact: "The county seat of Clinton County, St. Johns features a beautiful historic downtown, the Maple River, and a mix of Victorian-era homes and modern developments.",
    landmarks: ["Clinton County Courthouse", "Maple River", "Downtown St. Johns", "Mint Festival grounds"],
    commonIssues: ["Maple River flooding", "Historic downtown building restoration", "Residential basement flooding"],
    testimonial: { name: "St. Johns Downtown Merchant", text: "Spring flooding hit our historic building hard. M&M understood the old construction and restored it perfectly.", rating: 5 }
  },
  {
    name: "Fowler",
    slug: "fowler",
    ...
    population: "1,134",
    populationNum: 1134,
    keywords: ["Fowler MI", "Fowler Michigan", "Clinton County"],
    responseTime: "50 minutes",
    casesCompleted: 12,
    uniqueFact: "A small village in western Clinton County with strong German Catholic heritage, Fowler features well-maintained older homes and agricultural properties.",
    landmarks: ["Most Holy Trinity Church", "Fowler Village Park", "Rural Clinton County"],
    commonIssues: ["Older home plumbing issues", "Storm damage to farms", "Basement moisture"],
    testimonial: { name: "Fowler Area Homeowner", text: "Heavy rains flooded our basement. M&M had everything dried and treated for mold prevention within days.", rating: 5 }
  },
  {
    name: "Elsie",
    slug: "elsie",
    ...
    population: "990",
    populationNum: 990,
    keywords: ["Elsie MI", "Elsie Michigan", "Clinton County"],
    responseTime: "55 minutes",
    casesCompleted: 10,
    uniqueFact: "Located in northeastern Clinton County, Elsie is a small agricultural village along the Maple River known for its annual dairy festival.",
    landmarks: ["Elsie Village Park", "Maple River", "Historic Downtown Elsie"],
    commonIssues: ["River flooding", "Older home water damage", "Agricultural building restoration"],
    testimonial: { name: "Elsie Village Resident", text: "The Maple River flooded our property. M&M responded quickly and handled everything including our insurance claim.", rating: 5 }
  },
  {
    name: "Ovid",
    slug: "ovid",
    ...
    population: "1,572",
    populationNum: 1572,
    keywords: ["Ovid MI", "Ovid Michigan", "Clinton County"],
    responseTime: "55 minutes",
    casesCompleted: 16,
    uniqueFact: "A village in eastern Clinton County near the Shiawassee County line, Ovid features a charming downtown and residential areas with many older homes.",
    landmarks: ["Ovid Village Park", "Downtown Ovid", "Ovid-Elsie Area Historical Society"],
    commonIssues: ["Aging infrastructure water damage", "Basement flooding", "Storm damage"],
    testimonial: { name: "Ovid Homeowner", text: "Sump pump failed during a storm. M&M was here within the hour and extracted all the water before it reached our finished areas.", rating: 5 }
  },
  {
    name: "Maple Rapids",
    slug: "maple-rapids",
    ...
    population: "660",
    populationNum: 660,
    keywords: ["Maple Rapids MI", "Maple Rapids Michigan", "Clinton County"],
    responseTime: "55 minutes",
    casesCompleted: 7,
    uniqueFact: "Named for the rapids on the Maple River, this small village in northern Clinton County faces unique water challenges due to its riverfront location.",
    landmarks: ["Maple River", "Maple Rapids Village Park", "Historic Downtown"],
    commonIssues: ["Maple River flooding", "Seasonal water damage", "Older home restoration"],
    testimonial: { name: "Maple Rapids Riverside Owner", text: "The river floods regularly and M&M knows our property. They respond fast every time.", rating: 5 }
  },
  {
    name: "Westphalia",
    slug: "westphalia",
    ...
    population: "919",
    populationNum: 919,
    keywords: ["Westphalia MI", "Westphalia Michigan", "Clinton County"],
    responseTime: "50 minutes",
    casesCompleted: 9,
    uniqueFact: "A small village with rich German Catholic heritage in western Clinton County, Westphalia features the iconic St. Mary Church and well-maintained historic homes.",
    landmarks: ["St. Mary Catholic Church", "Westphalia Village Park", "Rural Clinton County"],
    commonIssues: ["Historic home water damage", "Basement moisture problems", "Storm damage"],
    testimonial: { name: "Westphalia Resident", text: "Our older home needed careful mold remediation. M&M was thorough and respectful of the historic elements.", rating: 5 }
  },
  {
    name: "Hubbardston",
    slug: "hubbardston",
    ...
    population: "387",
    populationNum: 387,
    keywords: ["Hubbardston MI", "Hubbardston Michigan", "Clinton County"],
    responseTime: "60 minutes",
    casesCompleted: 4,
    uniqueFact: "A small rural village at the northwestern edge of Clinton County, Hubbardston is a quiet farming community with homes dating back to the 1800s.",
    landmarks: ["Hubbardston Village Park", "St. John the Baptist Church", "Rural Clinton County"],
    commonIssues: ["Rural property flooding", "Historic home restoration", "Well water damage"],
    testimonial: { name: "Hubbardston Property Owner", text: "Even out in the country, M&M got to us fast. Professional crew handled our water damage perfectly.", rating: 5 }
  },
  // --- Shiawassee County locations ---
  {
    name: "Owosso",
    slug: "owosso",
    state: "MI",
    ...
    population: "14,834",
    populationNum: 14834,
    keywords: ["Owosso MI", "Owosso Michigan", "Shiawassee County"],
    responseTime: "50 minutes",
    casesCompleted: 78,
    uniqueFact: "The largest city in Shiawassee County, Owosso features a vibrant historic downtown along the Shiawassee River and is the birthplace of Thomas Dewey.",
    landmarks: ["Shiawassee River", "Curwood Castle", "Steam Railroading Institute", "Historic Downtown Owosso"],
    commonIssues: ["Shiawassee River flooding", "Historic building water damage", "Commercial property restoration"],
    testimonial: { name: "Owosso Downtown Business", text: "River flooding hit multiple businesses. M&M coordinated our restoration alongside the insurance company seamlessly.", rating: 5 }
  },
  {
    name: "Durand",
    slug: "durand",
    ...
    population: "3,446",
    populationNum: 3446,
    keywords: ["Durand MI", "Durand Michigan", "Shiawassee County"],
    responseTime: "55 minutes",
    casesCompleted: 34,
    uniqueFact: "Known as the 'Railroad City of Michigan,' Durand features a stunning 1903 Union Station and many railroad-era homes with unique architectural characteristics.",
    landmarks: ["Durand Union Station", "Michigan Railroad History Museum", "Veterans Memorial Park"],
    commonIssues: ["Older railroad-era home restoration", "Basement flooding", "Storm damage to historic structures"],
    testimonial: { name: "Durand Historic Homeowner", text: "Our 1900s railroad worker home had serious water damage. M&M restored it beautifully while keeping the character intact.", rating: 5 }
  },
  {
    name: "Corunna",
    slug: "corunna",
    ...
    population: "3,420",
    populationNum: 3420,
    keywords: ["Corunna MI", "Corunna Michigan", "Shiawassee County"],
    responseTime: "50 minutes",
    casesCompleted: 28,
    uniqueFact: "The county seat of Shiawassee County, Corunna sits along the Shiawassee River and features the historic courthouse and many well-preserved Victorian homes.",
    landmarks: ["Shiawassee County Courthouse", "Shiawassee River", "McCurdy Park", "Historic Downtown Corunna"],
    commonIssues: ["River flooding", "Victorian home restoration", "Municipal water main breaks"],
    testimonial: { name: "Corunna Property Manager", text: "Multiple rental properties affected by flooding. M&M handled all of them efficiently and kept our tenants informed.", rating: 5 }
  },
  {
    name: "Byron",
    slug: "byron",
    ...
    population: "584",
    populationNum: 584,
    keywords: ["Byron MI", "Byron Michigan", "Shiawassee County"],
    responseTime: "55 minutes",
    casesCompleted: 8,
    uniqueFact: "A small village in eastern Shiawassee County, Byron features rural charm and older homes along seasonal waterways prone to spring flooding.",
    landmarks: ["Byron Village Park", "Byron Area Historical Society", "Rural Shiawassee County"],
    commonIssues: ["Spring flooding", "Older home water damage", "Septic system failures"],
    testimonial: { name: "Byron Area Resident", text: "Spring thaw flooded our yard and basement. M&M extracted the water and set up drying equipment that saved our finished basement.", rating: 5 }
  },
  {
    name: "Morrice",
    slug: "morrice",
    ...
    population: "878",
    populationNum: 878,
    keywords: ["Morrice MI", "Morrice Michigan", "Shiawassee County"],
    responseTime: "55 minutes",
    casesCompleted: 9,
    uniqueFact: "A small village in southern Shiawassee County near the Ingham County border, Morrice serves as a quiet residential community for the greater Lansing area.",
    landmarks: ["Morrice Village Park", "Rural Shiawassee County", "Morrice Community"],
    commonIssues: ["Rural flooding", "Basement water intrusion", "Storm damage"],
    testimonial: { name: "Morrice Homeowner", text: "Burst pipe while we were away at work. M&M met the neighbors who called and handled everything before we got home.", rating: 5 }
  },
  {
    name: "Vernon",
    slug: "vernon",
    ...
    population: "850",
    populationNum: 850,
    keywords: ["Vernon MI", "Vernon Michigan", "Shiawassee County"],
    responseTime: "55 minutes",
    casesCompleted: 7,
    uniqueFact: "A rural community in southwestern Shiawassee County, Vernon features farmland and residential properties with many homes built in the early 20th century.",
    landmarks: ["Vernon Township Hall", "Rural Shiawassee County"],
    commonIssues: ["Aging home water damage", "Agricultural building restoration", "Foundation moisture"],
    testimonial: { name: "Vernon Township Resident", text: "Mold in our crawl space was a health concern. M&M remediated it completely and installed vapor barriers to prevent recurrence.", rating: 5 }
  },
  {
    name: "Bancroft",
    slug: "bancroft",
    ...
    population: "573",
    populationNum: 573,
    keywords: ["Bancroft MI", "Bancroft Michigan", "Shiawassee County"],
    responseTime: "60 minutes",
    casesCompleted: 5,
    uniqueFact: "A small village in northeastern Shiawassee County, Bancroft is a quiet farming community with properties requiring specialized rural restoration services.",
    landmarks: ["Bancroft Village Park", "Rural Shiawassee County"],
    commonIssues: ["Rural property flooding", "Well water contamination", "Storm damage to outbuildings"],
    testimonial: { name: "Bancroft Farmer", text: "Lightning struck our grain dryer and started a fire. M&M handled the fire damage cleanup and our insurance claim.", rating: 5 }
  },
  {
    name: "Lennon",
    slug: "lennon",
    ...
    population: "517",
    populationNum: 517,
    keywords: ["Lennon MI", "Lennon Michigan", "Shiawassee County"],
    responseTime: "55 minutes",
    casesCompleted: 5,
    uniqueFact: "A tiny village in eastern Shiawassee County near the Genesee County line, Lennon is a rural residential community with older homes and farmsteads.",
    landmarks: ["Lennon Village", "Rural eastern Shiawassee County"],
    commonIssues: ["Older home restoration", "Basement moisture", "Agricultural property damage"],
    testimonial: { name: "Lennon Area Homeowner", text: "Heavy rains overwhelmed our sump pump. M&M was here fast and prevented serious damage to our basement.", rating: 5 }
  },
  // --- Gratiot County locations ---
  {
    name: "Alma",
    slug: "alma",
    state: "MI",
    ...
    population: "9,383",
    populationNum: 9383,
    keywords: ["Alma MI", "Alma Michigan", "Gratiot County"],
    responseTime: "60 minutes",
    casesCompleted: 52,
    uniqueFact: "Home to Alma College and known as 'Scotland USA' for its Highland Festival, Alma features a charming downtown and mix of student housing and family homes.",
    landmarks: ["Alma College", "Highland Festival Grounds", "Pine River", "Downtown Alma"],
    commonIssues: ["Student housing water damage", "Pine River flooding", "Commercial building restoration"],
    testimonial: { name: "Alma College Facilities", text: "Water damage to a historic campus building needed expert care. M&M preserved the original architecture while solving the moisture problem.", rating: 5 }
  },
  {
    name: "St. Louis",
    slug: "st-louis",
    ...
    population: "7,482",
    populationNum: 7482,
    keywords: ["St Louis MI", "St. Louis Michigan", "Gratiot County"],
    responseTime: "60 minutes",
    casesCompleted: 38,
    uniqueFact: "Located at the confluence of the Pine and Chippewa Rivers, St. Louis faces unique flooding challenges and features many homes near these waterways.",
    landmarks: ["Pine River", "Chippewa River", "St. Louis City Park", "Downtown St. Louis"],
    commonIssues: ["River confluence flooding", "Residential water damage", "Storm drain overflow"],
    testimonial: { name: "St. Louis Riverside Homeowner", text: "Living between two rivers means flood risk. M&M knows our area and responds immediately when water rises.", rating: 5 }
  },
  {
    name: "Ithaca",
    slug: "ithaca",
    ...
    population: "2,869",
    populationNum: 2869,
    keywords: ["Ithaca MI", "Ithaca Michigan", "Gratiot County"],
    responseTime: "60 minutes",
    casesCompleted: 22,
    uniqueFact: "The county seat of Gratiot County, Ithaca features the historic courthouse, a walkable downtown, and residential areas along the Pine River.",
    landmarks: ["Gratiot County Courthouse", "Pine River", "Ithaca City Park", "Historic Downtown"],
    commonIssues: ["Pine River flooding", "Historic building restoration", "Basement water damage"],
    testimonial: { name: "Ithaca Downtown Business Owner", text: "Spring flooding hit our store. M&M had us dried out and reopened within a week. They handled insurance too.", rating: 5 }
  },
  {
    name: "Breckenridge",
    slug: "breckenridge",
    ...
    population: "1,325",
    populationNum: 1325,
    keywords: ["Breckenridge MI", "Breckenridge Michigan", "Gratiot County"],
    responseTime: "60 minutes",
    casesCompleted: 11,
    uniqueFact: "A small village in southern Gratiot County, Breckenridge is an agricultural community with older homes and properties that require specialized restoration care.",
    landmarks: ["Breckenridge Village Park", "Rural Gratiot County", "Pine River nearby"],
    commonIssues: ["Agricultural building damage", "Older home water damage", "Severe storm damage"],
    testimonial: { name: "Breckenridge Homeowner", text: "Tornado damaged our roof and rain poured in. M&M tarped the roof immediately and dried everything out.", rating: 5 }
  },
  {
    name: "Ashley",
    slug: "ashley",
    ...
    population: "559",
    populationNum: 559,
    keywords: ["Ashley MI", "Ashley Michigan", "Gratiot County"],
    responseTime: "60 minutes",
    casesCompleted: 6,
    uniqueFact: "A small rural village in southwestern Gratiot County, Ashley is a farming community where properties range from historic village homes to working agricultural operations.",
    landmarks: ["Ashley Village Park", "Rural Gratiot County"],
    commonIssues: ["Farm building fire damage", "Seasonal flooding", "Aging plumbing failures"],
    testimonial: { name: "Ashley Area Farmer", text: "Equipment shed fire could have been devastating. M&M cleaned up the fire and smoke damage quickly and professionally.", rating: 5 }
  },
  // --- Isabella County locations ---
  {
    name: "Mt. Pleasant",
    slug: "mt-pleasant",
    state: "MI",
    ...
    population: "21,746",
    populationNum: 21746,
    keywords: ["Mt Pleasant MI", "Mount Pleasant Michigan", "Isabella County"],
    responseTime: "60 minutes",
    casesCompleted: 87,
    uniqueFact: "Home to Central Michigan University, Mt. Pleasant is the largest city in Isabella County with a vibrant college-town atmosphere and diverse housing stock.",
    landmarks: ["Central Michigan University", "Chippewa River", "Island Park", "Downtown Mt. Pleasant"],
    commonIssues: ["Student housing water damage", "Chippewa River flooding", "Commercial property restoration", "Rental property emergencies"],
    testimonial: { name: "Mt. Pleasant Property Management Co.", text: "Managing student rentals means water damage emergencies. M&M is our go-to - fast, reliable, and fair pricing.", rating: 5 }
  },
  {
    name: "Shepherd",
    slug: "shepherd",
    ...
    population: "1,515",
    populationNum: 1515,
    keywords: ["Shepherd MI", "Shepherd Michigan", "Isabella County"],
    responseTime: "60 minutes",
    casesCompleted: 14,
    uniqueFact: "A small village in eastern Isabella County known for its Maple Syrup Festival, Shepherd features older homes and rural properties along Salt River.",
    landmarks: ["Shepherd Village Park", "Salt River", "Maple Syrup Festival Grounds"],
    commonIssues: ["Salt River flooding", "Older home restoration", "Agricultural property damage"],
    testimonial: { name: "Shepherd Village Resident", text: "The Salt River flooded our backyard and crawl space. M&M extracted the water and prevented mold from taking hold.", rating: 5 }
  },
  {
    name: "Weidman",
    slug: "weidman",
    ...
    population: "982",
    populationNum: 982,
    keywords: ["Weidman MI", "Weidman Michigan", "Isabella County"],
    responseTime: "65 minutes",
    casesCompleted: 8,
    uniqueFact: "A rural community in western Isabella County, Weidman features lakeside properties near Coldwater Lake and rural homes requiring specialized restoration services.",
    landmarks: ["Coldwater Lake", "Weidman Community", "Rural Isabella County"],
    commonIssues: ["Lake property moisture damage", "Rural property flooding", "Storm damage"],
    testimonial: { name: "Coldwater Lake Property Owner", text: "Moisture from the lake was causing mold in our cottage. M&M remediated it and waterproofed the crawl space.", rating: 5 }
  },
  // --- Livingston County locations ---
  {
    name: "Howell",
    slug: "howell",
    state: "MI",
    ...
    population: "9,489",
    populationNum: 9489,
    keywords: ["Howell MI", "Howell Michigan", "Livingston County"],
    responseTime: "55 minutes",
    casesCompleted: 68,
    uniqueFact: "The county seat of Livingston County, Howell features a beautiful historic downtown, Thompson Lake, and a thriving mix of older and newer homes.",
    landmarks: ["Historic Downtown Howell", "Thompson Lake", "Howell Nature Center", "Livingston County Courthouse"],
    commonIssues: ["Lake-area moisture damage", "Historic building restoration", "Basement flooding in older neighborhoods"],
    testimonial: { name: "Downtown Howell Shop Owner", text: "Pipe burst flooded our retail space overnight. M&M had commercial drying equipment running by dawn and saved our inventory.", rating: 5 }
  },
  {
    name: "Brighton",
    slug: "brighton",
    ...
    population: "7,444",
    populationNum: 7444,
    keywords: ["Brighton MI", "Brighton Michigan", "Livingston County"],
    responseTime: "55 minutes",
    casesCompleted: 58,
    uniqueFact: "A growing city in southeastern Livingston County, Brighton is surrounded by lakes and features upscale neighborhoods, a charming downtown, and significant commercial development.",
    landmarks: ["Mill Pond", "Brighton State Recreation Area", "Downtown Brighton", "Mount Brighton"],
    commonIssues: ["Lakefront property water damage", "New construction moisture issues", "Storm damage"],
    testimonial: { name: "Brighton Lakefront Homeowner", text: "Lake moisture caused hidden mold behind our bathroom walls. M&M found it, removed it, and fixed the source.", rating: 5 }
  },
  {
    name: "Fowlerville",
    slug: "fowlerville",
    ...
    population: "2,886",
    populationNum: 2886,
    keywords: ["Fowlerville MI", "Fowlerville Michigan", "Livingston County"],
    responseTime: "50 minutes",
    casesCompleted: 32,
    uniqueFact: "Located in western Livingston County along I-96, Fowlerville is a growing community that bridges the rural and suburban character of Mid-Michigan.",
    landmarks: ["Fowlerville Fairgrounds", "Downtown Fowlerville", "I-96 corridor"],
    commonIssues: ["Basement flooding", "Storm damage", "New development drainage issues"],
    testimonial: { name: "Fowlerville Homeowner", text: "New home had drainage problems the builder wouldn't fix. M&M waterproofed our basement properly and it's been dry since.", rating: 5 }
  },
  {
    name: "Pinckney",
    slug: "pinckney",
    ...
    population: "2,365",
    populationNum: 2365,
    keywords: ["Pinckney MI", "Pinckney Michigan", "Livingston County"],
    responseTime: "55 minutes",
    casesCompleted: 24,
    uniqueFact: "A charming village in southern Livingston County surrounded by lakes and the Pinckney State Recreation Area, many properties are lakefront or seasonal.",
    landmarks: ["Pinckney State Recreation Area", "Hell Creek Ranch nearby", "Downtown Pinckney"],
    commonIssues: ["Lakefront property moisture", "Seasonal cottage restoration", "Crawl space moisture"],
    testimonial: { name: "Pinckney Lake Cottage Owner", text: "Opened the cottage in spring to find major water damage. M&M restored everything in time for summer.", rating: 5 }
  },
  {
    name: "Hartland",
    slug: "hartland",
    ...
    population: "14,663",
    populationNum: 14663,
    keywords: ["Hartland MI", "Hartland Michigan", "Livingston County"],
    responseTime: "55 minutes",
    casesCompleted: 45,
    uniqueFact: "A large township in eastern Livingston County, Hartland features numerous lakes, newer subdivisions, and a strong community identity centered around excellent schools.",
    landmarks: ["Hartland Music Hall", "Parshallville Cider Mill", "Long Lake", "Hartland Consolidated Schools"],
    commonIssues: ["Lake property water damage", "New construction moisture issues", "Sump pump failures"],
    testimonial: { name: "Hartland Township Family", text: "Sump pump died during a thunderstorm and our basement flooded. M&M was there in under an hour. Lifesavers!", rating: 5 }
  },
  // --- Barry County locations ---
  {
    name: "Hastings",
    slug: "hastings",
    state: "MI",
    ...
    population: "7,350",
    populationNum: 7350,
    keywords: ["Hastings MI", "Hastings Michigan", "Barry County"],
    responseTime: "60 minutes",
    casesCompleted: 42,
    uniqueFact: "The county seat of Barry County, Hastings sits along the Thornapple River and features a well-preserved downtown with buildings dating to the 1860s.",
    landmarks: ["Thornapple River", "Barry County Courthouse", "Charlton Park Historic Village", "Fish Hatchery"],
    commonIssues: ["Thornapple River flooding", "Historic building restoration", "Commercial property water damage"],
    testimonial: { name: "Hastings Business District Owner", text: "The Thornapple flooded our building's lower level. M&M had it dried and sanitized within days. Outstanding work.", rating: 5 }
  },
  {
    name: "Nashville",
    slug: "nashville",
    ...
    population: "1,677",
    populationNum: 1677,
    keywords: ["Nashville MI", "Nashville Michigan", "Barry County"],
    responseTime: "60 minutes",
    casesCompleted: 15,
    uniqueFact: "A small village in eastern Barry County, Nashville features turn-of-the-century architecture and rural properties along the Thornapple River tributary system.",
    landmarks: ["Nashville Village Park", "Thornapple River area", "Historic Nashville"],
    commonIssues: ["Rural flooding", "Older home water damage", "Storm damage to agricultural buildings"],
    testimonial: { name: "Nashville Area Homeowner", text: "Our century-old home had hidden water damage behind plaster walls. M&M detected and fixed it without destroying the original plaster.", rating: 5 }
  },
  {
    name: "Middleville",
    slug: "middleville",
    ...
    population: "3,319",
    populationNum: 3319,
    keywords: ["Middleville MI", "Middleville Michigan", "Barry County"],
    responseTime: "60 minutes",
    casesCompleted: 24,
    uniqueFact: "Located along the Thornapple River in western Barry County, Middleville is a growing community with a mix of historic homes and newer developments.",
    landmarks: ["Thornapple River", "Paul Henry Thornapple Trail", "Downtown Middleville"],
    commonIssues: ["River flooding", "New construction drainage issues", "Basement moisture"],
    testimonial: { name: "Middleville Thornapple River Resident", text: "Spring floods are part of river life here. M&M has helped us three years running - always professional and fast.", rating: 5 }
  },
  {
    name: "Delton",
    slug: "delton",
    ...
    population: "909",
    populationNum: 909,
    keywords: ["Delton MI", "Delton Michigan", "Barry County"],
    responseTime: "65 minutes",
    casesCompleted: 10,
    uniqueFact: "A small community in southern Barry County near the Kalamazoo County line, Delton features lake properties and rural homes requiring specialized restoration approaches.",
    landmarks: ["Delton Village", "Nearby lakes", "Rural Barry County"],
    commonIssues: ["Lake property moisture", "Rural storm damage", "Seasonal property issues"],
    testimonial: { name: "Delton Lake Property Owner", text: "Moisture damage in our lake house was worse than we thought. M&M uncovered and fixed everything completely.", rating: 5 }
  },
  // --- Ionia County locations ---
  {
    name: "Ionia",
    slug: "ionia",
    state: "MI",
    ...
    population: "11,394",
    populationNum: 11394,
    keywords: ["Ionia MI", "Ionia Michigan", "Ionia County"],
    responseTime: "55 minutes",
    casesCompleted: 62,
    uniqueFact: "The county seat of Ionia County along the Grand River, Ionia features a historic downtown, the Michigan Reformatory, and the annual Ionia Free Fair.",
    landmarks: ["Grand River", "Ionia Free Fair Grounds", "Historic Downtown Ionia", "Ionia State Recreation Area"],
    commonIssues: ["Grand River flooding", "Historic building restoration", "Commercial property water damage"],
    testimonial: { name: "Ionia Downtown Merchant", text: "Grand River flooding threatened our historic building. M&M responded within the hour and minimized the damage significantly.", rating: 5 }
  },
  {
    name: "Portland",
    slug: "portland",
    ...
    population: "3,884",
    populationNum: 3884,
    keywords: ["Portland MI", "Portland Michigan", "Ionia County"],
    responseTime: "50 minutes",
    casesCompleted: 35,
    uniqueFact: "Located along the Grand and Looking Glass Rivers in western Ionia County, Portland faces unique dual-river flooding challenges and features a charming downtown.",
    landmarks: ["Grand River", "Looking Glass River", "Portland Riverwalk", "Bogue Flats"],
    commonIssues: ["Dual-river flooding", "Historic home water damage", "Riverfront property restoration"],
    testimonial: { name: "Portland Riverside Homeowner", text: "Two rivers mean double the flood risk. M&M understands our unique situation and always responds quickly.", rating: 5 }
  },
  {
    name: "Belding",
    slug: "belding",
    ...
    population: "5,709",
    populationNum: 5709,
    keywords: ["Belding MI", "Belding Michigan", "Ionia County"],
    responseTime: "55 minutes",
    casesCompleted: 38,
    uniqueFact: "A former silk manufacturing hub along the Flat River, Belding features many beautiful Victorian-era factory workers' homes and commercial buildings.",
    landmarks: ["Flat River", "Belding Museum", "Historic Downtown Belding", "Flat River Community Forest"],
    commonIssues: ["Flat River flooding", "Victorian home restoration", "Commercial building damage"],
    testimonial: { name: "Belding Historic Home Owner", text: "Our 1890s Victorian had water in the walls from a roof leak. M&M dried it without damaging the ornate woodwork.", rating: 5 }
  },
  {
    name: "Saranac",
    slug: "saranac",
    ...
    population: "1,327",
    populationNum: 1327,
    keywords: ["Saranac MI", "Saranac Michigan", "Ionia County"],
    responseTime: "55 minutes",
    casesCompleted: 14,
    uniqueFact: "A small village in southern Ionia County along the Grand River, Saranac features a historic downtown and riverside properties with seasonal flooding risks.",
    landmarks: ["Grand River", "Saranac Village Park", "Historic Downtown Saranac"],
    commonIssues: ["Grand River flooding", "Older home water damage", "Storm damage"],
    testimonial: { name: "Saranac Village Resident", text: "Grand River flooding hit our home for the first time. M&M walked us through the whole process including insurance.", rating: 5 }
  },
  {
    name: "Lyons",
    slug: "lyons",
    ...
    population: "687",
    populationNum: 687,
    keywords: ["Lyons MI", "Lyons Michigan", "Ionia County"],
    responseTime: "55 minutes",
    casesCompleted: 8,
    uniqueFact: "A small village along the Grand River in central Ionia County, Lyons features historic homes and a peaceful rural setting with river-related flooding risks.",
    landmarks: ["Grand River", "Lyons Village Park", "Rural Ionia County"],
    commonIssues: ["River flooding", "Older home restoration", "Rural property damage"],
    testimonial: { name: "Lyons Area Homeowner", text: "The Grand River got our basement. M&M had pumps running within the hour and handled everything professionally.", rating: 5 }
  },
  {
    name: "Muir",
    slug: "muir",
    ...
    population: "614",
    populationNum: 614,
    keywords: ["Muir MI", "Muir Michigan", "Ionia County"],
    responseTime: "55 minutes",
    casesCompleted: 6,
    uniqueFact: "Adjacent to Lyons along the Grand River, Muir is a small village with historic character and riverside properties requiring flood-aware restoration expertise.",
    landmarks: ["Grand River", "Muir Village", "Rural Ionia County"],
    commonIssues: ["Grand River flooding", "Historic home water damage", "Storm damage"],
    testimonial: { name: "Muir Village Resident", text: "Small town, big water problem. M&M treated us like their most important customer. Couldn't ask for better service.", rating: 5 }
  }
];
...
export const COUNTIES = [
  {
    ...
    cities: ["lansing", "east-lansing", "mason", "okemos", "haslett", "holt", "williamston", "webberville", "stockbridge", "delhi-charter-township", "meridian-charter-township", "leslie", "dansville", "onondaga", "bunker-hill", "white-oak"],
  ...
  },
  {
    ...
    cities: ["charlotte", "grand-ledge", "eaton-rapids", "dimondale", "potterville", "vermontville", "olivet", "waverly", "delta-charter-township", "windsor-charter-township", "bellevue", "mulliken", "sunfield"],
  ...
  },
  {
    ...
    cities: ["dewitt", "bath", "eagle", "laingsburg", "st-johns", "fowler", "elsie", "ovid", "maple-rapids", "westphalia", "hubbardston"],
    majorCities: ["St. Johns", "DeWitt", "Bath", "Ovid"],
    landmarks: ["Looking Glass River", "Sleepy Hollow State Park", "Clinton County Courthouse", "Maple River"],
    commonIssues: ["New construction drainage issues", "Septic system failures", "Rural property flooding", "Maple River flooding"]
  },
  {
    name: "Shiawassee County",
    slug: "shiawassee-county",
    state: "MI",
    population: "68,000",
    description: "Northeast of Lansing, Shiawassee County features the historic cities of Owosso and Corunna along the Shiawassee River.",
    cities: ["owosso", "durand", "corunna", "byron", "morrice", "vernon", "bancroft", "lennon"],
    majorCities: ["Owosso", "Durand", "Corunna"],
    landmarks: ["Shiawassee River", "Curwood Castle", "Durand Union Station", "Steam Railroading Institute"],
    commonIssues: ["Shiawassee River flooding", "Historic building restoration", "Railroad-era home water damage", "Rural property storm damage"]
  },
  {
    name: "Gratiot County",
    slug: "gratiot-county",
    state: "MI",
    population: "41,000",
    description: "In the heart of Mid-Michigan, Gratiot County is home to Alma College and features the Pine River running through its communities.",
    cities: ["alma", "st-louis", "ithaca", "breckenridge", "ashley"],
    majorCities: ["Alma", "St. Louis", "Ithaca"],
    landmarks: ["Alma College", "Pine River", "Gratiot County Courthouse", "Highland Festival Grounds"],
    commonIssues: ["Pine River flooding", "Student housing water damage", "Agricultural property restoration", "Historic downtown building damage"]
  },
  {
    name: "Isabella County",
    slug: "isabella-county",
    state: "MI",
    population: "64,000",
    description: "Home to Central Michigan University in Mt. Pleasant, Isabella County is a vibrant college community in the center of Mid-Michigan.",
    cities: ["mt-pleasant", "shepherd", "weidman"],
    majorCities: ["Mt. Pleasant", "Shepherd"],
    landmarks: ["Central Michigan University", "Chippewa River", "Island Park", "Soaring Eagle Casino"],
    commonIssues: ["Student housing water damage", "Chippewa River flooding", "Commercial property restoration", "Lake property moisture damage"]
  },
  {
    ...
    state: "MI",
    population: "193,000",
    description: "Southeast of Lansing, Livingston County is one of Michigan's fastest-growing counties with numerous lakes and upscale communities.",
    cities: ["howell", "brighton", "fowlerville", "pinckney", "hartland"],
    majorCities: ["Howell", "Brighton", "Hartland", "Fowlerville"],
    landmarks: ["Historic Downtown Howell", "Brighton State Recreation Area", "Mount Brighton", "Kensington Metropark nearby"],
    commonIssues: ["Lakefront property water damage", "New construction drainage issues", "Sump pump failures", "Storm damage to newer developments"]
  },
  {
    name: "Barry County",
    slug: "barry-county",
    state: "MI",
    population: "62,000",
    description: "Southwest of Lansing, Barry County features the Thornapple River, Charlton Park Historic Village, and a mix of small towns and rural properties.",
    cities: ["hastings", "nashville", "middleville", "delton"],
    majorCities: ["Hastings", "Middleville", "Nashville"],
    landmarks: ["Thornapple River", "Charlton Park Historic Village", "Barry County Courthouse", "Barry State Game Area"],
    commonIssues: ["Thornapple River flooding", "Historic building restoration", "Agricultural property damage", "Rural property storm damage"]
  },
  {
    name: "Ionia County",
    slug: "ionia-county",
    state: "MI",
    population: "65,000",
    description: "West of Lansing along the Grand River, Ionia County features historic downtowns, the Ionia Free Fair, and extensive riverfront properties.",
    cities: ["ionia", "portland", "belding", "saranac", "lyons", "muir"],
    majorCities: ["Ionia", "Portland", "Belding"],
    landmarks: ["Grand River", "Ionia Free Fair Grounds", "Flat River", "Portland Riverwalk"],
    commonIssues: ["Grand River flooding", "Historic building water damage", "Flat River flooding", "Rural property restoration"]
  }
];
